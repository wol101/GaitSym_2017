...
bool CNSOGLManager::generateSurface()
{
    if (Params.DriverType == video::EDT_OPENGL)
    {
        ...
        // wis - added explicit casts to stop compiler errors
        NSOpenGLPixelFormatAttribute Attribs[] =
        {
            ...
            NSOpenGLPFAStencilSize, Params.Stencilbuffer ? static_cast<NSOpenGLPixelFormatAttribute>(1) : static_cast<NSOpenGLPixelFormatAttribute>(0),
