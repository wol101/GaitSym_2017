    ...
    m_ui(new Ui::DialogOutputSelect)
{
    ...
    restoreGeometry(m_preferences.valueQByteArray("DialogOutputSelectGeometry"));
}
...
Preferences DialogOutputSelect::preferences() const
{
    return m_preferences;
}

void DialogOutputSelect::setPreferences(const Preferences &preferences)
{
...
{
    m_preferences.insert("DialogOutputSelectGeometry", saveGeometry());
    accept();
}
