...
// wis - bug fix - these defines needed even when joystick is not
...
#ifdef __MAC_10_6
    // wis - added static_cast<CGMouseButton> cast to stop compiler complaints
    // CGEventRef ev = CGEventCreateMouseEvent(0, kCGEventMouseMoved, c, 0);
    CGEventRef ev = CGEventCreateMouseEvent(0, kCGEventMouseMoved, c, static_cast<CGMouseButton>(0));
    // ~wis - added static_cast<CGMouseButton> cast to stop compiler complaints
