...
double ButterworthFilter::xn() const
{
    return m_xn;
}
...
void ButterworthFilter::AddNewSample(double x)
{
    ...
    m_yn  =  m_b0*m_xn + m_b1*m_xnminus1 + m_b2*m_xnminus2 + m_a1*m_ynminus1 + m_a2*m_ynminus2;
}
...
double SharedButterworthFilter::xn() const
{
    return m_xn;
}
